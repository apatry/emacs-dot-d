...
Let's configure [[https://github.com/bbatsov/projectile][projectile]] and it helm ui to make it easy to browse in
project:
...
[[https://github.com/tmalsburg/helm-bibtex][helm-bibtex]] support searching quickly through a bibliography and
...
With this configuration, helm-bibtex is both compatible with org-noter
...
(use-package org-ref
  ...
  :config
    ...
    (setq org-ref-default-bibliography (list "~/org-roam/bibliography.bib"))
